...
export default async function FriendsSection({
  ...
  return (
    <div className="flex flex-col md:flex-row items-start gap-3">
		<div className="md:w-1/2 min-w-0 p-5 border-2 border-[#65bfd4] shadow-sm rounded-xl overflow-hidden">
		<h3 className="flex justify-center text-[#007d99]">My Friends</h3><br />
        <MyFriends myFriends={myFriends} currentUserId={id} />
		</div>
		<div className="md:w-1/2 min-w-0 p-5 border-2 border-[#a993f3] shadow-sm rounded-xl">
