    ...
    <aside className="m-auto flex flex-col gap-5 w-64 bg-white shadow-lg p-6 border-r border-gray-300">
      ...
      <nav className="flex flex-col gap-3 space-y-3">
        <button
          ...
          className="w-1/2 text-center px-4 py-3 bg-white border-2 border-gray-300 rounded-lg text-lg font-bold text-gray-900 hover:bg-gray-900 hover:border-white hover:text-white transition"
        >
          Users
        </button>
